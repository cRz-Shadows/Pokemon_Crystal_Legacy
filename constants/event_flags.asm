...
; Unused: next 48 events
	...
	const EVENT_POKEDISTRIBUTIONMAN_RECEIVEDGIFT
	const EVENT_POKEDISTRIBUTIONMAN_CHERRYGROVE
	const EVENT_POKEDISTRIBUTIONMAN_VIOLET
	const EVENT_POKEDISTRIBUTIONMAN_AZALEA
	const EVENT_POKEDISTRIBUTIONMAN_GOLDENROD
	const EVENT_POKEDISTRIBUTIONMAN_ECRUTEAK
	const EVENT_POKEDISTRIBUTIONMAN_CIANWOOD
	const EVENT_POKEDISTRIBUTIONMAN_OLIVINE
	const EVENT_POKEDISTRIBUTIONMAN_MAHOGANY
	const EVENT_POKEDISTRIBUTIONMAN_BLACKTHORN
