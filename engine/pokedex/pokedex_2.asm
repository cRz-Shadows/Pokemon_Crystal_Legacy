	...
	const DEXENTRY_AREA_TREES_COMMON   ; 17
	const DEXENTRY_AREA_TREES_RARE   ; 18
	const DEXENTRY_AREA_ROCKSMASH   ; 19
	const DEXENTRY_AREA_CONTEST ; 20
	const DEXENTRY_AREA_ROAMING ; 20
